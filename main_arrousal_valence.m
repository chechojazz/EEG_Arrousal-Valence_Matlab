...
intervals.arrMean = zeros(length(intervals.s)/2,1);%set array for interval mean
intervals.arrStd = zeros(length(intervals.s)/2, 1);
k=1;%interval counter
...
intervals.valMean = zeros(length(intervals.s)/2, 1);%set array for interval mean
intervals.valStd = zeros(length(intervals.s)/2, 1);
k=1;%interval counter
